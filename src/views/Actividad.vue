    ...
    .row.mb-5.justify-content-center.align-items-center.align-items-lg-stretch
      .col-6.col-md-4.col-lg-3.mb-4.mb-md-0
        .tarjeta.h-100.d-flex.align-items-center.p-4
          figure
            img(src="@/assets/template/completar2.svg", alt="img-1")
      .col-12.col-md-8.col-lg-9
        .titulo-segundo
          h2 Condiciones comerciales de proveedores
        ...
        p.mb-4 Se debe completar la frase con la palabra que falta, acorde a la definición de cada enunciado propuesto. ¡Adelante y mucho ánimo! 
